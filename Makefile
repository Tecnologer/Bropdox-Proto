...
go:
	protoc --go_out=../models/proto --go_opt=paths=source_relative --go-grpc_out=require_unimplemented_servers=false:../models/proto --go-grpc_opt=paths=source_relative ./bropdox.proto
